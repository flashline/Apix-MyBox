...
class SubModel  {
	...
	function get_recordsCtnr() :Elem { 
		return elem.elemByClass("apix_recordsSubCtnr");
	}
	public var bElem(get, null):Elem; function get_bElem() :Elem { 
		return elem.elemByClass("apix_txtField");
	}
