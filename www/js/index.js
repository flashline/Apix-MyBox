...
var app = {
    ...
    initialize: function() {
		...
		//remove comment to test in PC browser
    ...
    onDeviceReady: function() {
		document.getElementById(app.appElementId).removeChild(document.getElementById(app.deviceReadyElementId));
    ...
    haxeAppStart: function() {
		...
		*/
		...
		//window.location.replace("http://www.apixline.org/pm/app/web/myBox/index.html");
		var s = document.createElement('script');
		s.src = "js/main.js"; 
		document.getElementsByTagName("head")[0].appendChild(s);	
